...
import com.google.leafcoin.net.discovery.DnsDiscovery;
...
import com.google.leafcoin.store.*;
...
public class WalletTool {
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("leafcoin")) {
            try {
                ...
                System.err.println("Invalid leafcoin uri: " + e.getMessage());
                System.exit(1);
            } catch (InterruptedException e) {
                // Ignore.
            } catch (ExecutionException e) {
