...
import com.google.leafcoin.script.ScriptChunk;
import com.google.leafcoin.store.UnreadableWalletException;
import com.google.leafcoin.store.WalletProtobufSerializer;
import com.google.leafcoin.utils.ListenerRegistration;
import com.google.leafcoin.utils.Threading;
import com.google.leafcoin.wallet.*;
import com.google.leafcoin.wallet.WalletTransaction.Pool;
...
import static com.google.leafcoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.leafcoin.core.Utils.bitcoinValueToPlainString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.leafcoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.leafcoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.leafcoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.leafcoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
...
//                            throw new IllegalArgumentException("Tried to send dust with ensureMinRequiredFee set - no way to complete this");
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.leafcoin.wallet.WalletFiles.Listener)}
    ...
    public String toString(boolean includePrivateKeys, boolean includeTransactions, boolean includeExtensions,
        ...
        try {
            ...
            builder.append(String.format("Wallet containing %s LEAF (available: %s LEAF) in:%n",
     ...
     * of {@link com.google.leafcoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.leafcoin.crypto.KeyCrypter,
     ...
     * {@link com.google.leafcoin.crypto.KeyCrypterScrypt}.
     *
        ...
        try {
            ...
            for (ECKey key : keychain) {
                if (key.isEncrypted()) {
                    ...
                    // (all leafcoin controlled by that private key is lost forever).
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.leafcoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.leafcoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.leafcoin.core.TransactionBroadcaster broadcaster) {
