...
import com.google.leafcoin.params.*;
import com.google.leafcoin.script.Script;
import com.google.leafcoin.script.ScriptOpCodes;
...
import static com.google.leafcoin.core.Utils.COIN;
...
public abstract class NetworkParameters implements Serializable {
     ...
     */
    public static final int PROTOCOL_VERSION = 80004;
    ...
    public static final String ID_MAINNET = "org.leafcoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.leafcoin.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.leafcoin.unittest";
        ...
        try {
            ...
            byte[] bytes = Hex.decode
                   // ("04ffff001d0104084e696e746f6e646f");
            		("04ffff001d0104084c6561666f6e646f");
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.leafcoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.leafcoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.leafcoin.core.AlertMessage}s. You can use {@link com.google.leafcoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
