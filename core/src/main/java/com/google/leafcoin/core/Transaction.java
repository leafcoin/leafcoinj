...
import com.google.leafcoin.crypto.TransactionSignature;
...
import static com.google.leafcoin.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final BigInteger MIN_NONDUST_OUTPUT = BigInteger.ONE; //LEAF: We can send one "shibetoshi" but this will cost us extra fee!

    // These are serialized in both leafcoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.leafcoin.script.Script, ECKey, com.google.leafcoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.leafcoin.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.leafcoin.it/wiki/Contracts
