...
import com.google.leafcoin.net.ClientConnectionManager;
import com.google.leafcoin.net.NioClientManager;
import com.google.leafcoin.net.discovery.PeerDiscovery;
import com.google.leafcoin.net.discovery.PeerDiscoveryException;
import com.google.leafcoin.params.MainNetParams;
import com.google.leafcoin.script.Script;
import com.google.leafcoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    private volatile int vMinRequiredProtocolVersion = 80007; //MainNetParams.PROTOCOL_VERSION;
     ...
     *         Use {@link com.google.leafcoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.leafcoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.leafcoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.leafcoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.leafcoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.leafcoin.core.Peer#ping()}.
     */
